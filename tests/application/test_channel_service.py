...
class TestChannelServiceImpl:
    ...
    def valid_channel_data(self):
        ...
        return {
            ...
            "destinations": [
                {"type": "http", "url": "http://example.com/webhook", "method": "POST"}
            ],
        }
    ...
    async def test_create_channel_success(
        self, channel_service, mock_repository, valid_channel_data
    ):
        """测试创建通道成功 - TDD RED阶段"""
        # Arrange
    ...
    @pytest.mark.asyncio
    async def test_create_channel_already_exists(
        self, channel_service, mock_repository, valid_channel_data, sample_channel
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_channel_validation_error_empty_name(
        self, channel_service, mock_repository, valid_channel_data
    ):
        """测试创建通道验证错误 - 空名称"""
        # Arrange
    ...
    @pytest.mark.asyncio
    async def test_create_channel_validation_error_no_destinations(
        self, channel_service, mock_repository, valid_channel_data
    ):
        """测试创建通道验证错误 - 无目标"""
        # Arrange
    ...
    async def test_get_channel_by_id_success(
        self, channel_service, mock_repository, sample_channel
    ):
        """测试根据ID获取通道成功"""
        # Arrange
